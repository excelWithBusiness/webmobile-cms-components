const mockAsset = {
  ...
  language: 'en',
  partOfSession: '0',
  provider: { __typename: 'Provider', id: 42, name: 'Lovefilm', logoUrl: '' },
  interaction: {
    __typename: 'Interaction',
    launched: false,
    bookmarked: true,
  },
  type: { __typename: 'Type', id: 2, name: 'Article' },
  timebox: {
    __typename: 'Timebox',
  ...
  competencies: [
    { __typename: 'Competency', id: 1507, text: 'Be respectful, to everyone' },
    {
      __typename: 'Competency',
      id: 1508,
      text: 'Collaborate productively and harmoniously',
    },
    { __typename: 'Competency', id: 1509, text: 'Be galvanised, galvanise!' },
    {
      __typename: 'Competency',
      id: 1514,
  ...
  description:
    'Rothman explores the environment in which leaders and leadership arises, claiming that “people who fetishize leadership sometimes find themselves longing for crisis”. He goes on to explore how leadership styles have evolved through the ages and the problems the modern leader faces.',
  embedVideoURL: '',
  sponsored: false,
}
            ...
            staticPlaylists: [
              {
                ...
                staticAssetTiles: [
                  {
                    description:
                      'Quisque non ornare tellus vivamus pharetra elementum metus in scelerisque',
                    id: 32001,
                    type: 'Article',
                    duration: '16 mins',
                  ...
                  {
                    description:
                      'Suspendisse mauris est, commodo non justo in, posuere rutrum nulla',
                    id: 32002,
                    type: 'Article',
                    duration: '16 mins',
                    provider: 'BBC',
