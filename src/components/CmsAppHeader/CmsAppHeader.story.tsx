...
storiesOf('CMS Components/AppHeader', module)
  .add('Default', () => {
  return (
    <CmsAppHeader headerContent={header?.data.header} logoUrl={logoData?.logo.url} onLogoClick={action('Logo')} button={{ href: '#', actionLabel: ''}} />
  )
})
